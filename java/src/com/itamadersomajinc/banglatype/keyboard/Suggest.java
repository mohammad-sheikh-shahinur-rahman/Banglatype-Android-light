...
import static com.itamadersomajinc.banglatype.keyboard.define.DecoderSpecificConstants.SHOULD_AUTO_CORRECT_USING_NON_WHITE_LISTED_SUGGESTION;
import static com.itamadersomajinc.banglatype.keyboard.define.DecoderSpecificConstants.SHOULD_REMOVE_PREVIOUSLY_REJECTED_SUGGESTION;
...
public final class Suggest {
    ...
    private void getSuggestedWordsForNonBatchInput(final WordComposer wordComposer,
        ...
        // Inject custom phonetic suggestions if we are in Avro typing mode
        final String avroRoman = wordComposer.getAvroRomanString();
        if (avroRoman != null && !avroRoman.isEmpty()) {
            final java.util.List<SuggestedWordInfo> phoneticSuggestions = AvroPhoneticDictionary.getSuggestions(
                    avroRoman, null);
            if (phoneticSuggestions != null && !phoneticSuggestions.isEmpty()) {
                suggestionsContainer.addAll(0, phoneticSuggestions);
            }
        }
