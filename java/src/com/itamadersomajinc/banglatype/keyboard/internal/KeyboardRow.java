...
public final class KeyboardRow {
    ...
    private static class RowAttributes {
        ...
        public RowAttributes(final TypedArray keyAttr, final float defaultKeyWidth,
            ...
            if (keyAttr != null) {
                ...
                mDefaultBackgroundType = Key.BACKGROUND_TYPE_NORMAL;
            }
        }
    ...
    public KeyboardRow(final KeyboardParams params, final int y) {
        mParams = params;
        mRowHeight = params.mDefaultRowHeight;
        mRowAttributesStack.push(new RowAttributes(null, params.mDefaultKeyWidth, params.mBaseWidth));
        mCurrentY = y;
        mCurrentX = 0.0f;
    }
