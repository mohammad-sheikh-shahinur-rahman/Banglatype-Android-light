...
import com.itamadersomajinc.banglatype.keyboard.InputAttributes;
...
public final class Settings implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String PREF_CUSTOM_THEME_ENABLED = "pref_custom_theme_enabled";
    public static final String PREF_CUSTOM_KEY_COLOR = "pref_custom_key_color";
    public static final String PREF_CUSTOM_KEY_TEXT_COLOR = "pref_custom_key_text_color";
    public static final String PREF_CUSTOM_BACKGROUND_COLOR = "pref_custom_background_color";
    ...
    public static boolean readGestureInputEnabled(final SharedPreferences prefs,
            final Resources res) {
        return prefs.getBoolean(PREF_GESTURE_INPUT, true);
    }
