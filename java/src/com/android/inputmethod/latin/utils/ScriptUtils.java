...
public class ScriptUtils {
    ...
    public static final int SCRIPT_CHAKMA = 18;
    ...
    static {
        ...
        mLanguageCodeToScriptCode.put("ccp", SCRIPT_CHAKMA);
    }
    ...
    public static boolean isLetterPartOfScript(final int codePoint, final int scriptId) {
        ...
        case SCRIPT_CHAKMA:
            // Chakma unicode block is U+11100..U+1114F
            return (codePoint >= 0x11100 && codePoint <= 0x1114F);
        case SCRIPT_UNKNOWN:
            return true;
        default:
