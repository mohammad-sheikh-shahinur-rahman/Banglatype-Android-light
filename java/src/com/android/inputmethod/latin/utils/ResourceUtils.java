...
public final class ResourceUtils {
    ...
    public static int getDefaultKeyboardHeight(final Resources res) {
        final DisplayMetrics dm = res.getDisplayMetrics();
        final boolean isLandscape = dm.heightPixels < dm.widthPixels;

        // Standard keyboard height in DP: Portrait 280dp, Landscape 200dp
        final float heightDp = isLandscape ? 200.0f : 280.0f;
        final float keyboardHeight = heightDp * dm.density;
