...
import com.itamadersomajinc.banglatype.dictionarypack.UpdateHandler;
import com.itamadersomajinc.banglatype.keyboard.AssetFileAddress;
import com.android.inputmethod.latin.BinaryDictionaryGetter;
import com.itamadersomajinc.banglatype.keyboard.R;
import com.itamadersomajinc.banglatype.keyboard.RichInputMethodManager;
import com.itamadersomajinc.banglatype.keyboard.common.FileUtils;
import com.itamadersomajinc.banglatype.keyboard.common.LocaleUtils;
import com.itamadersomajinc.banglatype.keyboard.define.DecoderSpecificConstants;
import com.itamadersomajinc.banglatype.keyboard.makedict.DictionaryHeader;
import com.itamadersomajinc.banglatype.keyboard.makedict.UnsupportedFormatException;
...
public class DictionaryInfoUtils {
    ...
    /**
     * Returns the package that owns the app resources. NOTE: when applicationId differs from
     * the namespace/R package this is NOT the same as the R class package, so it must be read
     * from the resource table at runtime; otherwise getIdentifier() returns 0.
     */
    public static String getResourcePackageName(final Resources res) {
        return res.getResourcePackageName(R.string.subtype_generic);
    }
    ...
    public static int getMainDictionaryResourceIdIfAvailableForLocale(final Resources res,
        ...
        if (!locale.getCountry().isEmpty()) {
            ...
            if ((resId = res.getIdentifier(
                    dictLanguageCountry, "raw", getResourcePackageName(res))) != 0) {
                return resId;
            }
        }
        ...
        if ((resId = res.getIdentifier(dictLanguage, "raw", getResourcePackageName(res))) != 0) {
            return resId;
        }
    ...
    public static int getMainDictionaryResourceId(final Resources res, final Locale locale) {
        ...
        return res.getIdentifier(DEFAULT_MAIN_DICT + DecoderSpecificConstants.DECODER_DICT_SUFFIX,
                "raw", getResourcePackageName(res));
    }
