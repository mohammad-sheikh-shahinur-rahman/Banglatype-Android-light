...
package com.itamadersomajinc.banglatype.keyboard.common;
...
public final class Constants {
    ...
    public static final class ImeOption {
         ...
         * {@link com.itamadersomajinc.banglatype.keyboard.settings.SettingsValues#mGestureFloatingPreviewTextEnabled}
         */
     ...
     * {@link com.itamadersomajinc.banglatype.keyboard.KeyboardActionListener#onCustomRequest(int)}.
     */
    public static final int CUSTOM_CODE_SHOW_INPUT_METHOD_PICKER = 1;
    // The code to switch to the next input subtype.
    public static final int CUSTOM_CODE_SWITCH_TO_NEXT_SUBTYPE = 2;
    // The code to switch to the previous input subtype.
    public static final int CUSTOM_CODE_SWITCH_TO_PREV_SUBTYPE = 3;
    // The codes to move text cursor.
    public static final int CUSTOM_CODE_MOVE_CURSOR_LEFT = 4;
    public static final int CUSTOM_CODE_MOVE_CURSOR_RIGHT = 5;
     ...
     * {@link com.itamadersomajinc.banglatype.keyboard.internal.KeyboardCodesSet}.
     */
    ...
    // New toolbar action codes
    public static final int CODE_CLIPBOARD = -16;
    public static final int CODE_THEME = -17;
    public static final int CODE_TRANSLATE = -18;
    public static final int CODE_UNDO = -19;
    public static final int CODE_REDO = -20;
    public static final int CODE_SELECT_ALL = -21;
    public static final int CODE_CUT = -22;
    public static final int CODE_COPY = -23;
    public static final int CODE_PASTE = -24;
    public static final int CODE_FLOATING_ON = -25;
    public static final int CODE_FLOATING_OFF = -26;
    public static final int CODE_ONE_HANDED_LEFT = -27;
    public static final int CODE_ONE_HANDED_RIGHT = -28;
    public static final int CODE_FULL_MODE = -29;
    public static final int CODE_LAYOUT_PICKER = -30;
     ...
     * {@link com.itamadersomajinc.banglatype.latin.R.integer#config_screen_metrics}.
     */
     ...
     * This constant is used by {@link com.itamadersomajinc.banglatype.keyboard.internal.BatchInputArbiter}
